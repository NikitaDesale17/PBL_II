 ...
 * @author Nikita
 */
public class needimp extends javax.swing.JFrame {
    public String studname;
        public int mrk;
    /*
     * Creates new form needimp
     */
    public needimp(String snm,int marks) {
        initComponents();
        studname=snm;
        mrk=marks;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Requires improvement");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(needimp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
